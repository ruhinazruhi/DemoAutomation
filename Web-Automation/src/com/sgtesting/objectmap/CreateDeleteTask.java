...
public class CreateDeleteTask {
	...
	private static void createTask()
	{
		...
		{
			Thread.sleep(3000);
			wb.findElement(obj.getLocator("TaskAddNewTask")).click();
			Thread.sleep(2000);
			wb.findElement(obj.getLocator("TaskCreateNewTask")).click();
			Thread.sleep(2000);
			wb.findElement(obj.getLocator("TaskTaskNameField1")).sendKeys("Task 1 200 test cases");
			Thread.sleep(2000);
			wb.findElement(obj.getLocator("TaskTaskNameField2")).sendKeys("Task 2 300 test cases");
			Thread.sleep(2000);
			wb.findElement(obj.getLocator("TaskCreatetaskBtn")).click();
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void deleteTask()
	{
		try
		{
			...
			wb.findElement(obj.getLocator("HomeTaskTab")).click();
			Thread.sleep(4000);
			wb.findElement(obj.getLocator("TaskTask1Link")).click();
			Thread.sleep(4000);
			wb.findElement(obj.getLocator("TaskActionBtn")).click();
			Thread.sleep(4000);
			wb.findElement(obj.getLocator("TaskDeleteBtn")).click();
			Thread.sleep(5000);
			wb.findElement(obj.getLocator("TestDeletePerBtn")).click();
			Thread.sleep(6000);
			wb.findElement(obj.getLocator("TaskTask2Link")).click();
			Thread.sleep(3000);
			wb.findElement(obj.getLocator("TaskActionBtn")).click();
			Thread.sleep(3000);
			wb.findElement(obj.getLocator("TaskDeleteBtn")).click();
