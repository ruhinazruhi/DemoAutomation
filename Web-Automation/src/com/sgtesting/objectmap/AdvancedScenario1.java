...
//		FlyOutWindow();
	...
	private static void modifyUsers()
	{
		try
		{
			...
			//------------------------------------------
			Thread.sleep(4000);
			wb.findElement(obj.getLocator("User3Link")).click();
			Thread.sleep(2000);
			wb.findElement(obj.getLocator("UserPasswordTextFiled")).sendKeys("abc");
			Thread.sleep(2000);
			wb.findElement(obj.getLocator("UserRePasswordTextField")).sendKeys("abc");
	...
	private static void ModiLoginUser1()
	{
		try
		{
			Thread.sleep(4000);
...
//			wb.findElement(obj.getLocator("StartExploreLink")).click();
	...
	private static void deleteUsers()
	{
		try
		{
			...
			wb.findElement(obj.getLocator("User1Link")).click();
			Thread.sleep(2000);
			wb.findElement(obj.getLocator("deleteUser")).click();
			Thread.sleep(1000);
			...
			wb.findElement(obj.getLocator("deleteUser")).click();
			Thread.sleep(2000);
			Alert oAlert1=wb.switchTo().alert();
			oAlert1.accept();
			//--------------------------------------------
			Thread.sleep(3000);
			wb.findElement(obj.getLocator("User3Link")).click();
			...
			wb.findElement(obj.getLocator("deleteUser")).click();
			Thread.sleep(1000);
			Alert oAlert2=wb.switchTo().alert();
			oAlert2.accept();
		}
		catch(Exception e)
		{
